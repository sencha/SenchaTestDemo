...
folder are mapped to the application's root namespace, 'StarterApplication'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'StarterApplication' in the same way
as `"StarterApplication/sass/src"`.
