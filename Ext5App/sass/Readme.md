...
folder are mapped to the application's root namespace, 'Ext5App'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Ext5App' in the same way
as `"Ext5App/sass/src"`.
